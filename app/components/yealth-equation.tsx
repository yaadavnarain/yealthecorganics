...
/** How long the mark takes to fade up once it arrives at LANDED. */
...
export function BrandEquation() {
  ...
  //
  // Sequencing, taken from the TIMELINE rather than chosen:
  //   LANDED  3915   the mark fades up as the letters' burst fires, and the
  //                  slot flares in unison with it
